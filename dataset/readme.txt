...
🕒 Time Ranges per Day (in local time, UTC+5:30 assumed):
    ...
    Afternoon session: 12:00:00 → 13:59:55

    Evening session: 18:00:00 → 19:59:55

Data was generated at 5-second intervals, so each 2-hour session contains:

    2 hours × 60 minutes × 60 seconds / 5 = 1440 readings per session

Thus, each day has 3 × 1440 = 4320 entries, and the full week includes:

    4320 × 7 = 30,240 readings
